...
<body>
    <div class="sidebar">
        ...
        <a href="dashboard"><img src="assets/img/dashboard.png" alt="Dashboard Icon">Dashboard</a>
        ...
        <a href="financial-statements"><img src="assets/img/Vector.png" alt="Financial Icon">Financial Statements</a>
    </div>

    <div class="content">
        <a href="financial-statements"><img src="assets/img/gbr1.png" alt="Financial Icon">Financial Statements</a>
        
        <div class="row">
            <div class="col-md-4">
                <div class="info-box">
                    <a href="total-project"> <!-- Link to Total Projects Page -->
                        <div class="icon-box">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    <a href="income"> <!-- Link to Income Page -->
                        <div class="icon-box">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    <a href="expenses"> <!-- Link to Expense Page -->
                        <div class="icon-box">
