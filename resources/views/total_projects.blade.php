...
<body>
    ...
    <div class="content">
        <!-- Tombol ke halaman laporan keuangan -->
        <a href="{{ url('/financial_statements') }}">
            <img src="{{ asset('assets/img/gbr1.png') }}" alt="Dashboard Icon"> Laporan Keuangan
        </a>
                    ...
                    @forelse ($projects as $key => $project)
                        <tr>
                            ...
                            <td>
                               ...
                               <a href="{{ route('total-project.edit', $project->id_total_project) }}" class="btn btn-warning">
                                   <i class="fas fa-pencil-alt"></i>
                               </a>

                                <!-- Tombol Delete -->
                                <form action="{{ route('total-project.destroy', $project->id_total_project) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
        ...
        <a href="{{ route('total-project.create') }}" class="btn btn-success"> Buat data</a>
    </div>
